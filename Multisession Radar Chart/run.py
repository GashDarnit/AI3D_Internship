...
#hard-coded colors => means that there is a limit to only 16 total viewable sessions at a time to avoid array out of bounds for colors
colors = ['red', 'green', 'blue', 'yellow', 'orange', 'purple', 'brown', 'black', 'gray', 'cyan', 'magenta', 'lime', 'pink', 'teal', 'violet', 'olive']
