    ...
    \begin{minipage}{\linewidth}
        ...
        \begin{tikzpicture}[scale=1]
            ...
            \BLOCK{for i in range(max_joint)}
                ...
                \path (\VAR{i+1}*\JA:\L) node ({L\VAR{i+1}}) [align=center]{\footnotesize {J\VAR{ '{:02d}'.format(res+1) }}\\ \footnotesize \VAR{data['joints'][res]}\%};    
            \BLOCK{endfor}
            ...
            \BLOCK{for j in range(data['joints']|length)}
                ...
                ({\VAR{j+1}*\JA}:{(\VAR{(data['joints'][res] / 10) | round(3)}/10)/(1)*\R})
