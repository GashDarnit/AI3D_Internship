...
\begin{minipage}[c]{\linewidth}
    ...
    \begin{minipage}{\linewidth}
        ...
        \begin{tikzpicture}[scale=1]
            ...
            (D1-\VAR{(data['consistency'] / 10) | round(3)}) --
            (D2-\VAR{(data['grouping'] / 10) | round(3)}) --
            (D3-\VAR{(data['aiming'] / 10) | round(3)}) --
            (D4-\VAR{(data['strength'] / 10) | round(3)}) --
            (D5-\VAR{(data['bow balance'] / 10) | round(3)}) --
            (D6-\VAR{(data['bow stability'] / 10) | round(3)}) --
            (D7-\VAR{(data['anchor'] / 10) | round(3)}) --
            (D8-\VAR{(data['dfl'] / 10) | round(3)}) -- cycle;
    ...
    \begin{minipage}{\linewidth}
        ...
        \begin{tikzpicture}[scale=1]
            ...
            % define labels for each dimension axis (names config option)
            \path (1*\JA:\L) node (L1) [align=center]{\footnotesize J02\\ \footnotesize \VAR{data['joints'][1]}\%};
            \path (2*\JA:\L) node (L2) [align=center]{\footnotesize J01\\ \footnotesize \VAR{data['joints'][0]}\%};
            \path (3*\JA:\L) node (L3) [align=center]{\footnotesize J10\\ \footnotesize \VAR{data['joints'][9]}\%};
            \path (4*\JA:\L) node (L4) [align=center]{\footnotesize J09\\ \footnotesize \VAR{data['joints'][8]}\%};
            \path (5*\JA:\L) node (L5) [align=center]{\footnotesize J08\\ \footnotesize \VAR{data['joints'][7]}\%};
            \path (6*\JA:\L) node (L6) [align=center]{\footnotesize J07\\ \footnotesize \VAR{data['joints'][6]}\%};
            \path (7*\JA:\L) node (L7) [align=center]{\footnotesize J06\\ \footnotesize \VAR{data['joints'][5]}\%};
            \path (8*\JA:\L) node (L8) [align=center]{\footnotesize J05\\ \footnotesize \VAR{data['joints'][4]}\%};
            \path (9*\JA:\L) node (L9) [align=center]{\footnotesize J04\\ \footnotesize \VAR{data['joints'][3]}\%};
            \path (10*\JA:\L) node (L10) [align=center]{\footnotesize J03\\ \footnotesize \VAR{data['joints'][2]}\%};
            ...
            (D1-\VAR{(data['joints'][1] / 10) | round(3)}) --
            (D2-\VAR{(data['joints'][0] / 10) | round(3)}) --
            (D3-\VAR{(data['joints'][9] / 10) | round(3)}) --
            (D4-\VAR{(data['joints'][8] / 10) | round(3)}) --
            (D5-\VAR{(data['joints'][7] / 10) | round(3)}) --
            (D6-\VAR{(data['joints'][6] / 10) | round(3)}) --
            (D7-\VAR{(data['joints'][5] / 10) | round(3)}) --
            (D8-\VAR{(data['joints'][4] / 10) | round(3)}) --
            (D9-\VAR{(data['joints'][3] / 10) | round(3)}) --
            (D10-\VAR{(data['joints'][2] / 10) | round(3)}) -- cycle;
