...
\pagestyle{fancy}
\fancyhf{}
{% raw %}\rhead{{% endraw %}{{ report_id }}{% raw %}}{% endraw %}
\lhead{\includegraphics[width=3.5cm]{ {{ logo_icon }} }}
...
\section*{\centering {\LARGE \textbf{\underline{ {{ athlete_name }} }}}}
\vspace{-0.1cm}
...
\begin{minipage}[c]{\linewidth}
    ...
    \newlength{\imgwidth}
    \newlength{\imgheight}
    \settowidth{\imgwidth}{\includegraphics{ {{ skeleton_joints }} }}
    \settoheight{\imgheight}{\includegraphics{ {{ skeleton_joints }} }}
    ...
    \begin{minipage}{4cm}
        ...
        % Enlarged Display
        \adjincludegraphics[height=4cm, width=3.5cm, trim={0 0 {0.5\width} 0},clip]{ {{ hand_release }} } % Left Half
...
\begin{minipage}[c]{\linewidth}
    ...
    \begin{minipage}{\linewidth}
        ...
        \begin{tikzpicture}[scale=1]
            ...
            %D7 - Anchor
            %D8 - DFL
            \path (1*\A:\L) node (L1) [align=center]{\footnotesize Consistency\\ \footnotesize {{ data['consistency'] }}\%};
            \path (2*\A:\L) node (L2) [align=center]{\footnotesize Grouping\\ \footnotesize {{ data['grouping'] }}\%};
            \path (3*\A:\L) node (L3) [align=center]{\footnotesize Aiming\\ \footnotesize {{ data['aiming'] }}\%};
            \path (4*\A:\L) node (L4) [align=center]{\footnotesize Strength\\ \footnotesize {{ data['strength'] }}\%};
            \path (5*\A:\L) node (L5) [align=center]{\footnotesize Bow Balance\\ \footnotesize {{ data['bow balance'] }}\%};
            \path (6*\A:\L) node (L6) [align=center]{\footnotesize Bow Stability\\ \footnotesize {{ data['bow stability'] }}\%};
            \path (7*\A:\L) node (L7) [align=center]{\footnotesize Anchor\\ \footnotesize {{ data['anchor'] }}\%};
            \path (8*\A:\L) node (L8) [align=center]{\footnotesize DFL\\ \footnotesize {{ data['dfl'] }}\%};
    ...
    \begin{minipage}{\linewidth}
        ...
        {% endraw %}
            % define labels for each dimension axis (names config option)
            \path (1*\JA:\L) node (L1) [align=center]{\footnotesize J02\\ \footnotesize {{ data['joints'][0] }}\%};
            \path (2*\JA:\L) node (L2) [align=center]{\footnotesize J01\\ \footnotesize {{ data['joints'][1] }}\%};
            \path (3*\JA:\L) node (L3) [align=center]{\footnotesize J10\\ \footnotesize {{ data['joints'][2] }}\%};
            \path (4*\JA:\L) node (L4) [align=center]{\footnotesize J09\\ \footnotesize {{ data['joints'][3] }}\%};
            \path (5*\JA:\L) node (L5) [align=center]{\footnotesize J08\\ \footnotesize {{ data['joints'][4] }}\%};
            \path (6*\JA:\L) node (L6) [align=center]{\footnotesize J07\\ \footnotesize {{ data['joints'][5] }}\%};
            \path (7*\JA:\L) node (L7) [align=center]{\footnotesize J06\\ \footnotesize {{ data['joints'][6] }}\%};
            \path (8*\JA:\L) node (L8) [align=center]{\footnotesize J05\\ \footnotesize {{ data['joints'][7] }}\%};
            \path (9*\JA:\L) node (L9) [align=center]{\footnotesize J04\\ \footnotesize {{ data['joints'][8] }}\%};
            \path (10*\JA:\L) node (L10) [align=center]{\footnotesize J03\\ \footnotesize {{ data['joints'][9] }}\%};
            ...
            (D1-{{ (data['joints'][1] / 10) | round(3) }}) --
            (D2-{{ (data['joints'][0] / 10) | round(3) }}) --
            (D3-{{ (data['joints'][9] / 10) | round(3) }}) --
            (D4-{{ (data['joints'][8] / 10) | round(3) }}) --
            (D5-{{ (data['joints'][7] / 10) | round(3) }}) --
            (D6-{{ (data['joints'][6] / 10) | round(3) }}) --
            (D7-{{ (data['joints'][5] / 10) | round(3) }}) --
            (D8-{{ (data['joints'][4] / 10) | round(3) }}) --
            (D9-{{ (data['joints'][3] / 10) | round(3) }}) --
            (D10-{{ (data['joints'][2] / 10) | round(3) }}) -- cycle;
...
\begin{minipage}[c]{\linewidth}
    ...
    \begin{minipage}{\linewidth}                  
        \begin{center}
            ...
            \textbf{\textcolor{LightCoral}{\scriptsize {{ data['score'][0] }}}} -                    \textbf{\textcolor{SkyBlue}{\scriptsize {{ data['score'][1] }}}} -                    \textbf{\textcolor{MediumSpringGreen}{\scriptsize {{ data['score'][2] }}}} -                    \textbf{\textcolor{Turquoise}{\scriptsize {{ data['score'][3] }}}} -                    \textbf{\textcolor{Orchid}{\scriptsize {{ data['score'][4] }}}} -\\
            \vspace{-0.2cm}
            \textbf{\textcolor{LightSeaGreen}{\scriptsize {{ data['score'][5] }}}} -                    \textbf{\textcolor{SandyBrown}{\scriptsize {{ data['score'][6] }}}} -                    \textbf{\textcolor{CornflowerBlue}{\scriptsize {{ data['score'][7] }}}} -                    \textbf{\textcolor{Silver}{\scriptsize {{ data['score'][8] }}}} -                    \textbf{\textcolor{LightSlateGray}{\scriptsize {{ data['score'][9] }}}}  
        \end{center}
    \end{minipage}%    
    \vspace{0.1cm}
    ...
    \begin{minipage}{0.9\linewidth}
        ...
        \definecolor{crosscolor}{named}{ {{ data['color'][0] }} }
        ...
        \draw[crosscolor, line width=0.6mm] 
            ...
            (46.74mm-40mm+2.1mm,-39.56mm+40mm-2.1mm) -- (46.74mm-40mm-2.1mm,-39.56mm+40mm+2.1mm);
                % Get the color for this index from the lookup table
        \definecolor{crosscolor}{named}{ {{ data['color'][1] }} }
        ...
        \draw[crosscolor, line width=0.6mm] 
            ...
            (39.58mm-40mm+2.1mm,-39.65mm+40mm-2.1mm) -- (39.58mm-40mm-2.1mm,-39.65mm+40mm+2.1mm);
                % Get the color for this index from the lookup table
        \definecolor{crosscolor}{named}{ {{ data['color'][2] }} }
        ...
        \draw[crosscolor, line width=0.6mm] 
            ...
            (40.15mm-40mm+2.1mm,-39.66mm+40mm-2.1mm) -- (40.15mm-40mm-2.1mm,-39.66mm+40mm+2.1mm);
                % Get the color for this index from the lookup table
        \definecolor{crosscolor}{named}{ {{ data['color'][3] }} }
        ...
        \draw[crosscolor, line width=0.6mm] 
            ...
            (42.38mm-40mm+2.1mm,-45.45615242270663mm+40mm-2.1mm) -- (42.38mm-40mm-2.1mm,-45.45615242270663mm+40mm+2.1mm);
                % Get the color for this index from the lookup table
        \definecolor{crosscolor}{named}{ {{ data['color'][4] }} }
        ...
        \draw[crosscolor, line width=0.6mm] 
            ...
            (39.65mm-40mm+2.1mm,-29.08mm+40mm-2.1mm) -- (39.65mm-40mm-2.1mm,-29.08mm+40mm+2.1mm);
                % Get the color for this index from the lookup table
        \definecolor{crosscolor}{named}{ {{ data['color'][5] }} }
        ...
        \draw[crosscolor, line width=0.6mm] 
            ...
            (39.17mm-40mm+2.1mm,-39.26mm+40mm-2.1mm) -- (39.17mm-40mm-2.1mm,-39.26mm+40mm+2.1mm);
                % Get the color for this index from the lookup table
        \definecolor{crosscolor}{named}{ {{ data['color'][6] }} }
        ...
        \draw[crosscolor, line width=0.6mm] 
            ...
            (42.47mm-40mm+2.1mm,-35.59384757729337mm+40mm-2.1mm) -- (42.47mm-40mm-2.1mm,-35.59384757729337mm+40mm+2.1mm);
                % Get the color for this index from the lookup table
        \definecolor{crosscolor}{named}{ {{ data['color'][7] }} }
        ...
        \draw[crosscolor, line width=0.6mm] 
            ...
            (39.44mm-40mm+2.1mm,-33.5mm+40mm-2.1mm) -- (39.44mm-40mm-2.1mm,-33.5mm+40mm+2.1mm);
                % Get the color for this index from the lookup table
        \definecolor{crosscolor}{named}{ {{ data['color'][8] }} }
        ...
        \draw[crosscolor, line width=0.6mm] 
            ...
            (39.3mm-40mm+2.1mm,-39.7mm+40mm-2.1mm) -- (39.3mm-40mm-2.1mm,-39.7mm+40mm+2.1mm);
                % Get the color for this index from the lookup table
        \definecolor{crosscolor}{named}{ {{ data['color'][9] }} }
    ...
    \begin{figure*}[!h]
        ...
        \begin{tabular}{C{0.15\linewidth}C{0.15\linewidth}C{0.15\linewidth}C{0.15\linewidth}C{0.15\linewidth}}
            ...
            \begin{minipage}{\linewidth}\centering
                \includegraphics[width=\linewidth]{ {{ data['processed jointset'][0] }} }
                \caption{\scriptsize } % <---- remarks/captions go here
            \end{minipage} &
            
            %J02
            \begin{minipage}{\linewidth}\centering
                \includegraphics[width=\linewidth]{ {{ data['processed jointset'][1] }} }
                \caption{\scriptsize } % <---- remarks/captions go here
            \end{minipage} &
            
            %J03
            \begin{minipage}{\linewidth}\centering
                \includegraphics[width=\linewidth]{ {{ data['processed jointset'][2] }} }
                \caption{\scriptsize } % <---- remarks/captions go here
            \end{minipage} &
            
            %J04
            \begin{minipage}{\linewidth}\centering
                \includegraphics[width=\linewidth]{ {{ data['processed jointset'][3] }} }
                \caption{\scriptsize } % <---- remarks/captions go here
            \end{minipage} &
            
            %J05
            \begin{minipage}{\linewidth}\centering
                \includegraphics[width=\linewidth]{ {{ data['processed jointset'][4] }} }
                \caption{\scriptsize } % <---- remarks/captions go here
            \end{minipage} \\
            ...
            %J06
            \begin{minipage}{\linewidth}\centering
                \includegraphics[width=\linewidth]{ {{ data['processed jointset'][5] }} } 
                \caption{\scriptsize } % <---- remarks/captions go here
            \end{minipage} &
            
            %J07
            \begin{minipage}{\linewidth}\centering
                \includegraphics[width=\linewidth]{ {{ data['processed jointset'][6] }} } 
                \caption{\scriptsize } % <---- remarks/captions go here
            \end{minipage} &
            
            %J08
            \begin{minipage}{\linewidth}\centering
                \includegraphics[width=\linewidth]{ {{ data['processed jointset'][7] }} }
                \caption{\scriptsize } % <---- remarks/captions go here
            \end{minipage} &
            
            %J09
            \begin{minipage}{\linewidth}\centering
                \includegraphics[width=\linewidth]{ {{ data['processed jointset'][8] }} } 
                \caption{\scriptsize } % <---- remarks/captions go here
            \end{minipage} &
            
            %J10
            \begin{minipage}{\linewidth}\centering
                \includegraphics[width=\linewidth]{ {{ data['processed jointset'][9] }} }
                \caption{\scriptsize } % <---- remarks/captions go here
            \end{minipage} \\
        \end{tabular}}
    \end{figure*}
